	...
	return (
		...
		>
			<div className='flex flex-wrap my-10 py-10'>
				<div className='flex flex-col justify-center text-center space-y-8 w-full pl-8 md:pl-24 pr-8 lg:px-24'>
				...
				<div className='inline-flex w-screen z-10 space-x-8 overflow-x-scroll overscroll-x-contain p-6'>
					<ul className='inline-flex w-screen md:w-1/4 space-x-2 md:space-x-10 md:ml-40'>
